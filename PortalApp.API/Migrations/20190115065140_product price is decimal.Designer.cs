...
namespace PortalApp.API.Migrations
{
    ...
    [Migration("20190115065140_product price is decimal")]
    partial class productpriceisdecimal
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortalApp.API.Models.Category", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("PortalApp.API.Models.CategoryProduct", b =>
                {
                    b.Property<Guid>("CategoryId");
            ...
            modelBuilder.Entity("PortalApp.API.Models.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("PortalApp.API.Models.Category", b =>
                {
                    b.HasOne("PortalApp.API.Models.Category")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("PortalApp.API.Models.CategoryProduct", b =>
                {
                    b.HasOne("PortalApp.API.Models.Category", "Category")
                        .WithMany("CategoryProducts")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("PortalApp.API.Models.Product", "Product")
                        .WithMany("CategoryProducts")
